 ...
 */
class CRM_Resource_Upgrader_Base {

  /**
   * @var CRM_Resource_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Resource_Upgrader(
        'de.systopia.resource',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Resource_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Resource_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
