...
class CRM_Resource_Page_ResourceDemandConditions extends CRM_Core_Page
{
    ...
    public function run()
    {
        ...
        Civi::resources()->addStyleFile(E::LONG_NAME, 'css/resource_demand_conditions.css', 10, 'page-header');
        Civi::resources()->addScriptFile(E::LONG_NAME, 'js/resource_demand_conditions.js', 10, 'page-header');
